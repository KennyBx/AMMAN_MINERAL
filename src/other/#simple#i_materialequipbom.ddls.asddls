...
@AbapCatalog.sqlViewName: '/SIMPLE/IMATEBOM'
...
define view /SIMPLE/I_MATERIALEQUIPBOM
                                                                  ...
                                                                  and $projection.LongAlterTextLanguage = _ProductText.Language
{
  ...
  key _Eqst.EquipmentNumber                   as Equipment,
  key _Eqst.Plant                             as Plant,
...
where
  bom_header.BillOfMaterialCategory = 'E'
