@AbapCatalog.sqlViewName: '/SIMPLE/IUOMS'
...
define view /SIMPLE/I_UnitOfMeasure
  as select from t006

    association [0..*] to /SIMPLE/I_UnitOfMeasureText as _Text
        on $projection.UnitOfMeasure = _Text.UnitOfMeasure
//
//    association [0..1] to /SIMPLE/I_UnitOfMeasureDms as _Dimension
//        on $projection.UnitOfMeasureDimension = _Dimension.UnitOfMeasureDimension
//    association [0..*] to /SIMPLE/I_UnitOfMeasureDmsText as _DimensionText
//        on $projection.UnitOfMeasureDimension = _DimensionText.UnitOfMeasureDimension
//
//    association [0..1] to /SIMPLE/I_UnitOfMeasureISOCode as _ISOCode
//        on $projection.UnitOfMeasureISOCode = _ISOCode.UnitOfMeasureISOCode
//    association [0..*] to /SIMPLE/I_UOMISOCodeText as _ISOCodeText
