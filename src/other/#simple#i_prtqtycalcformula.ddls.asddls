@AbapCatalog.sqlViewName: '/SIMPLE/IPRTQTFM'
...
define view /SIMPLE/I_PRTQtyCalcFormula
  as select from tc25
//  association [0..*] to /SIMPLE/I_PRTQtyCalcFmlaText as _Text on $projection.ProdnRsceToolQtyCalcFormula = _Text.ProdnRsceToolQtyCalcFormula
{
