@AbapCatalog.sqlViewName: '/SIMPLE/IBMPRTCS'
...
define view /SIMPLE/I_BOOOMatlPRTChgState
  as select from /SIMPLE/I_BOOOpPRTChangeState  as I_BOOOperationPRTChangeState
    inner join   /SIMPLE/I_MatlPRTByInternalKey as I_MaterialPRTByInternalKey on  I_BOOOperationPRTChangeState.ProductionResourceType       = I_MaterialPRTByInternalKey.ProductionResourceType
                                                                              and I_BOOOperationPRTChangeState.ProductionResourceInternalID = I_MaterialPRTByInternalKey.ProductionResourceInternalID

  association [1..1] to /SIMPLE/I_MatlPRTByInternalKey as _MaterialPRTByInternalKey on  $projection.ProductionResourceType       = _MaterialPRTByInternalKey.ProductionResourceType
