...
@AbapCatalog.sqlViewName: '/SIMPLE/IMAFBAI'
...
define view /SIMPLE/I_MATERIALFLOCBOMMAIN
  as select from /SIMPLE/P_BOMPermanentDeter   as bom_permanent

    inner join   /SIMPLE/I_MATERIALFLOCBOMLINK as bom_main on bom_main.BillOfMaterial = bom_permanent.BillOfMaterial
  ...
  //                                                                                     and $projection.BillOfMaterialVariant  = _bom_valid.BillOfMaterialVariant
{
  ...
  key bom_permanent.BillOfMaterial          as BillOfMaterial,
      ...
      bom_main.FunctionalLocation           as FunctionalLocation,
...
where
  bom_permanent.BillOfMaterialCategory = 'T'
