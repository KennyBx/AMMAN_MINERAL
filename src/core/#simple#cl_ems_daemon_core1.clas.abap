class /SIMPLE/CL_EMS_DAEMON_CORE1 definition
  public
...
public section.
  ...
  constants CV_DAEMON_NAME type ABAP_DAEMON_NAME value 'mcore_1' ##NO_TEXT.
  constants CV_CLASSNAME type ABAP_DAEMON_CLASS_NAME value '/SIMPLE/CL_EMS_DAEMON_CORE1' ##NO_TEXT.
  constants CV_CORE type STRING value 'mcore_1' ##NO_TEXT.
  class-data:
...
CLASS /SIMPLE/CL_EMS_DAEMON_CORE1 IMPLEMENTATION.
