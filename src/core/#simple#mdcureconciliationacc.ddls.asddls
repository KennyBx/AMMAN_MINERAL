@AbapCatalog.sqlViewName: '/SIMPLE/MDCUREAC'
@AbapCatalog.compiler.compareFilter: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: '[MDG] F4 - Customer Reconciliation Acc'
define view /SIMPLE/MDCURECONCILIATIONACC
  as select from    skb1 as t1
