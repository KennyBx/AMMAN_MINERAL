CLASS /simple/cl_ems_daemon_core3 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS: cv_daemon_name TYPE abap_daemon_name VALUE 'mcore_3',
               cv_classname   TYPE abap_daemon_class_name VALUE '/SIMPLE/CL_EMS_DAEMON_CORE3',
               cv_core        TYPE string VALUE 'mcore_3'.
...
CLASS /SIMPLE/CL_EMS_DAEMON_CORE3 IMPLEMENTATION.
