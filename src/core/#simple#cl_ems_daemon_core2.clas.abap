CLASS /simple/cl_ems_daemon_core2 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS: cv_daemon_name TYPE abap_daemon_name VALUE 'mcore_2',
               cv_classname   TYPE abap_daemon_class_name VALUE '/SIMPLE/CL_EMS_DAEMON_CORE2',
               cv_core        TYPE string VALUE 'mcore_2'.
...
CLASS /SIMPLE/CL_EMS_DAEMON_CORE2 IMPLEMENTATION.
  ...
  METHOD send.
    ...
    ELSE.
      ...
      send_retry_http( iv_daemon_name    = iv_daemon_name
                       iv_log            = iv_log
                       iv_host           = iv_host
