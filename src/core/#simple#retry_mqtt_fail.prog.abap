...
DATA: gt_api_log      TYPE TABLE OF gty_api_log,
      ...
      lo_ems_mqtt      TYPE REF TO /simple/cl_ems_mqtt,
...
IF gt_api_log IS NOT INITIAL.
  ...
  LOOP AT gt_api_log ASSIGNING FIELD-SYMBOL(<fs_api_log>).
    LOOP AT lt_connect INTO DATA(ls_connect).
      ...
      lv_destination  = 'ZSIMPLE_EVENT_MQTT'.
    ...
    lv_topic_name   = |{ ls_connect-topic }/{ lv_status }|.
    ...
    ls_code = lo_ems_mqtt->send_request(  is_log          = ls_log
